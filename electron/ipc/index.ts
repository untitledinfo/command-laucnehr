...
export function registerIpc(config: ConfigStore, getWindow: () => BrowserWindow | null) {
  ...
  ipcMain.handle('accounts:cancelMsaLogin', () => {
    msaLoginCancelled = true;
    return true;
  });
