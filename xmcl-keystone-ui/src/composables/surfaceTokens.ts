...
export const DEFAULT_SURFACE_BLUR = 56
...
export const DEFAULT_PANEL_RADIUS = 28
...
export const DEFAULT_CARD_PROMINENT_RADIUS = 28
...
export const DEFAULT_CARD_CLICKABLE_RADIUS = 28
...
export const DEFAULT_CARD_CLICKABLE_SHADOW_HOVER = '0 16px 32px -8px rgba(0, 0, 0, 0.3), 0 6px 16px -4px rgba(0, 0, 0, 0.18)'
/** Hover lift in px (negative = upward). */
export const DEFAULT_CARD_CLICKABLE_LIFT = -6
