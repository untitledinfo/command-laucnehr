<template>
  <div class="home">
    ...
    <div class="hero glass-panel">
      ...
      <div v-if="!store.activeAccount" class="launch-hint">
        No account selected.
        <button class="link-btn inline" @click="showAccounts = true">Choose or add one</button>
      </div>
      <div v-else-if="!selectedVersion" class="launch-hint">
        No version installed yet.
        <button class="link-btn inline" @click="showInstall = true">Install a version</button>
      </div>
...
async function launch() {
  ...
  try {
    ...
    await window.launcherApi.config.set({ server: serverAddress.value });
